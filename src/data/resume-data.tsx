...
export const RESUME_DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "工作主要内容如下：参与制定确定公司、产品或产品线的战略规划；收集并调查相关的市场需求、用户需求、产品需求；驻场参与了解客户需求并整理需求文档 ,参与产品定义；分析市场、行业、竞争对手发展状况及趋势，提供决策参考，参与决策；进行产品规划，撰写相关产品需求文档或商业计划等；参与产品设计，包括交互设计、视觉设计、前端开发、文案设计等；协调项目实施，包括沟通、会议、项目管理；参与项目验收，反馈建议，优化产品等；参与产品的运营、推广等工作。",
    },
    {
      company: "中科软科技股份有限公司",
      ...
      description:
        "工作主要内容如下：根据客户需求变更对项目进行二次开发，按照功能组件的详细设计，修复程序BUG,参与与其业务相关的需求变更；驻场参与了解客户需求并整理需求文档 ,参与产品定义等。",
    },
  ],
  skills: [
